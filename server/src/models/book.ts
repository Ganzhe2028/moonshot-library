...
export const updateBook = async (id: string, updates: Partial<Book>): Promise<Book> => {
  ...
  const allowedFields = ['title', 'authors', 'isbn', 'publisher', 'published_year', 
    'category', 'description', 'cover_image', 'total_copies', 'available_copies', 
